...
pub(crate) fn _try_parse_jsonplus_object<'doc>(
    ...
    while !p1.is_eod() {
        ...
        if let Some((key, mut p3)) = super::values::_try_parse_identifier(&p1)? {
            ...
            if let Some((_, mut p3)) = p3.consume_char_if_immutable(|x| (x == ':') | (x == '=')) {
                ...
                if let Some((object, p4)) = _try_parse_jsonplus_object(&p3)? {
                    ...
                    super::values::_try_parse_enclosed_string(&p3, "'")?
                {
                    properties.insert(
                        key,
                    ...
                    super::values::_try_parse_enclosed_string(&p3, "\"")?
                {
                    ...
                    p1 = p4
                } else if let Some((x, p4)) = super::values::_try_parse_nude_string(&p3)? {
...
pub(crate) fn _try_parse_jsonplus_array<'doc>(
    ...
    while !p1.is_eod() {
        ...
        if let Some((object, p4)) = _try_parse_jsonplus_object(&p1)? {
            ...
            p1 = p4;
        } else if let Some((single_quoted_content, p4)) = super::values::_try_parse_enclosed_string(&p1, "'")? {
            array.push(JsonPlusEntity::SingleQuotedString(single_quoted_content));
            p1 = p4;
        } else if let Some((double_quoted_content, p4)) = super::values::_try_parse_enclosed_string(&p1, "\"")? {
            ...
            p1 = p4
        } else if let Some((x, p4)) = super::values::_try_parse_nude_string(&p1)? {
